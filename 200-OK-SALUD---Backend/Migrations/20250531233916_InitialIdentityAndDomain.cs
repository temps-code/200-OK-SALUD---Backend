...
namespace _200_OK_SALUD___Backend.Migrations
{
    ...
    public partial class InitialIdentityAndDomain : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ReglaPrioridades",
                columns: table => new
                {
                    ReglaId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nombre = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Criterio = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Peso = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReglaPrioridades", x => x.ReglaId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PuntajePrioridad = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistorialMedicos", x => x.HistorialId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CitaPrioridades", x => new { x.CitaId, x.ReglaId });
                    table.ForeignKey(
                        name: "FK_CitaPrioridades_Citas_CitaId",
                        column: x => x.CitaId,
                        principalTable: "Citas",
                        principalColumn: "CitaId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CitaPrioridades_ReglaPrioridades_ReglaId",
                        column: x => x.ReglaId,
                        principalTable: "ReglaPrioridades",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EsAlertaTurno = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CitaPrioridades_ReglaId",
                table: "CitaPrioridades",
                column: "ReglaId");
